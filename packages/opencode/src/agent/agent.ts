...
import PROMPT_AGORA from "./prompt/agora.txt"
  ...
  const state = Instance.state(async () => {
    ...
    const result: Record<string, Info> = {
      ...
      legal: {
        name: "legal",
        description:
          "Legal research and document processing agent with access to Case.dev APIs for OCR, transcription, vault/RAG search, legal web search, and document formatting.",
        mode: "primary",
        options: {},
        native: true,
        color: "#6366f1",
      ...
      agora: {
        name: "agora",
        description:
          "Epistemic council that deliberates through five axiomatic frameworks (Inductivist, Deductivist, Consequentialist, Skeptic, Phenomenologist) to produce robust, multi-perspective answers.",
        mode: "primary",
        options: {},
        native: true,
        color: "#8b5cf6",
