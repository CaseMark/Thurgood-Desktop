    ...
    if (platform.checkUpdate && platform.update && platform.restart) {
      ...
      if (updateAvailable) {
        showToast({
          ...
          description: `A new version of Thurgood Desktop (${version}) is now available to install.`,
          actions: [
            {
                    ...
                    <DropdownMenu.Portal>
                      <DropdownMenu.Content>
                        <DropdownMenu.Item onSelect={() => closeProject(props.project.worktree)}>
                          <DropdownMenu.ItemLabel>Close case</DropdownMenu.ItemLabel>
                        </DropdownMenu.Item>
                      </DropdownMenu.Content>
                    </DropdownMenu.Portal>
                  </DropdownMenu>
        ...
        <div class="flex flex-col gap-1.5 self-stretch items-start shrink-0 px-2 py-3">
            ...
            <Match when={!providers.paid().length && expanded()}>
              <div class="rounded-md bg-background-stronger shadow-xs-border-base">
                <div class="p-3 flex flex-col gap-2">
                  ...
                  <div class="text-text-base">Thurgood uses Case.dev for AI-powered legal research.</div>
                  <div class="text-text-base">Connect your Case.dev account to get started.</div>
                </div>
                <Tooltip placement="right" value="Connect to Case.dev" inactive={expanded()}>
                  <Button
            ...
            <Match when={true}>
              <Tooltip placement="right" value="Connect to Case.dev" inactive={expanded()}>
                <Button
                  ...
                  onClick={connectProvider}
                >
                  <Show when={expanded()}>Connect to Case.dev</Show>
                </Button>
              </Tooltip>
            </Match>
          </Switch>
          <Show when={platform.openDirectoryPickerDialog}>
            ...
            >
              ...
              >
                <Show when={expanded()}>Open case</Show>
              </Button>
            </Tooltip>
          </Show>
