              ...
              {iife(() => {
                ...
                return (
                  <div class="flex flex-col gap-6">
                    <Switch>
                      <Match when={provider().id === "thurgood"}>
                        <div class="flex flex-col gap-4">
                          <div class="text-14-regular text-text-base">
                            Case.dev gives you access to powerful AI models optimized for legal research and coding
                            agents.
                          </div>
                          <div class="text-14-regular text-text-base">
                            With a single API key you'll get access to models such as Claude, GPT, Gemini and more.
                          </div>
                          <div class="text-14-regular text-text-base">
                            Visit{" "}
                            <Link href="https://case.dev/api-keys" tabIndex={-1}>
                              case.dev/api-keys
                            </Link>{" "}
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          code to connect your account and use {provider().name} models in Thurgood Desktop.
                        </div>
                        <form onSubmit={handleSubmit} class="flex flex-col items-start gap-4">
                          <TextField
                            autofocus
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          connect your account and use {provider().name} models in Thurgood Desktop.
                        </div>
